...
//	}
	...
	public String execute() {
		...
		try {
			...
			//java.util.logging.Logger.getLogger(UpdateItemAction.class.getName()).log(java.util.logging.Level.SEVERE,null,e);
		...
		try {
			...
			// TODO Auto-generated catch block
			java.util.logging.Logger.getLogger(UpdateItemAction.class.getName()).log(java.util.logging.Level.SEVERE,null,e2);
			//return ERROR;
