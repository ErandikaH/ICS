			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
						Country: <input id="countryCode" type="text" name="countryCode" /><br>
						Name: <input id="name" type="text" name="name" />
					        <input type="button" id="myButton" name="myButton" value="MyButton"><br>
		...
		<script type="text/javascript">
			jQuery(function($) {
				 $('#myButton').click(function(event){
			         var country = $("input#countryCode").val();
			         //alert(country);
					           ...
					           oSettings.jqXHR = $.ajax( {
					             ...
					             "success": fnCallback
			                                    ...
			                                    "aoColumns" : [
							                                   ...
							                                   { "mData": "secondaryContactName" },
							                                   { "mData": "address" },
							                                   { "mData": "telephone" },
							                                   { "mData": "fax" },
							                                   { "mData": "primaryContactMobile" },
							                                   { "mData": "secondaryContactMobile" },
							                                   { "mData": "primaryContactEmail" },
							                                   { "mData": "secondaryContactEmail" },
							                                   { "mData": "registrationDate" },
							                                   { "mData": "vendorAddedDate" },
							                                   { "mData": "remark" }
			                                               ]
					//,
					//"sScrollY": "200px",
				...
				oTable1.fnSetColumnVis( 3, false, false ); 
